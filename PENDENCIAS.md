...
- [ ] **Pré-visualizações do Cloudflare Pages sem trava**: `<branch>.onboardops.pages.dev` abre o app sem o Cloudflare Access. Adicionar destino `*.onboardops.pages.dev` na aplicação do Access, ou desligar "Preview deployments" no projeto Pages.
